	...
	<div id="siteContent" class="site-content">
		<section class="section section--project">
			<div class="project project--megoin">
							...
							<div class="col-xs-12 col-lg-10 col-lg-offset-1">
								<div class="row">
									<div class="col-xs-12 col-sm-5">
										<blockquote><i>“ Social location services tops the areas of interest for marketers, with 48% saying they're interested in using social apps and location technologies to drive customers in store. ”</i></blockquote>
									</div>
				...
				<div class="project__team bg-color-grey-50 my-0">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-lg-10 col-lg-offset-1 text-center">
								<h2 class="team-title text-uppercase">The Team</h2>
								<div class="team-member"><img src="includes/megoin/megoin__team.png" alt="Megoin Team"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="project__content my-0 bg-color-grey-100">
					<div class="container">
						<div class="row">
