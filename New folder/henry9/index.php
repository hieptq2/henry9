					...
					<div class="col-xs-12 col-lg-10 col-lg-offset-1">
						<div class="section__header">
							<div class="section__heading">
								...
								<h6 class="section__heading__subtitle">Currently available for full-time work, <br class="hidden-xs"> freelancer jobs or some beers at night, <br class="hidden-xs"> and would love to hear from you</h6>
							</div>
						</div>
						<div class="section__content">
